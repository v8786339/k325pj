...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set AXI_LITE_Specific [ipgui::add_page $IPINST -name "AXI LITE Specific"]
  set_property tooltip {AXI LITE Specific} ${AXI_LITE_Specific}
  ipgui::add_param $IPINST -name "C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR" -parent ${AXI_LITE_Specific}
  ipgui::add_param $IPINST -name "C_M_IO_AXI_ADDR_WIDTH" -parent ${AXI_LITE_Specific}
  ipgui::add_param $IPINST -name "C_M_IO_AXI_DATA_WIDTH" -parent ${AXI_LITE_Specific}
...
proc update_PARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH { PARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH } {
	# Procedure called to update C_M_IO_AXI_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH { PARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH } {
	# Procedure called to validate C_M_IO_AXI_ADDR_WIDTH
	return true
}

proc update_PARAM_VALUE.C_M_IO_AXI_DATA_WIDTH { PARAM_VALUE.C_M_IO_AXI_DATA_WIDTH } {
	# Procedure called to update C_M_IO_AXI_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_IO_AXI_DATA_WIDTH { PARAM_VALUE.C_M_IO_AXI_DATA_WIDTH } {
	# Procedure called to validate C_M_IO_AXI_DATA_WIDTH
	return true
}

proc update_PARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR { PARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR } {
	# Procedure called to update C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR { PARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR } {
	# Procedure called to validate C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR { MODELPARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR PARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR}] ${MODELPARAM_VALUE.C_M_IO_AXI_TARGET_SLAVE_BASE_ADDR}
}

proc update_MODELPARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH { MODELPARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH PARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH}] ${MODELPARAM_VALUE.C_M_IO_AXI_ADDR_WIDTH}
}

proc update_MODELPARAM_VALUE.C_M_IO_AXI_DATA_WIDTH { MODELPARAM_VALUE.C_M_IO_AXI_DATA_WIDTH PARAM_VALUE.C_M_IO_AXI_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_IO_AXI_DATA_WIDTH}] ${MODELPARAM_VALUE.C_M_IO_AXI_DATA_WIDTH}
}
