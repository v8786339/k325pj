...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("d_o_address0", 2, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("d_o_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("d_o_we0", 1, hls_out, 0, "ap_memory", "mem_we", 1),
	Port_Property("d_o_d0", 32, hls_out, 0, "ap_memory", "mem_din", 1),
	Port_Property("d_i_address0", 2, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("d_i_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("d_i_q0", 32, hls_in, 1, "ap_memory", "mem_dout", 1),
...
const char* HLS_Design_Meta::dut_name = "array_RAM";
