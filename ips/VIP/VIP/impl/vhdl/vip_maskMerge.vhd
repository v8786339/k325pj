...
architecture behav of vip_maskMerge is 
    ...
    signal AXIvideo2Mat_U0_src_axi1_TREADY : STD_LOGIC;
    ...
    signal Loop_loop_height_pro_U0_imagSrc_data_stream_0_V_read : STD_LOGIC;
    signal Loop_loop_height_pro_U0_imagSrc_data_stream_1_V_read : STD_LOGIC;
    signal Loop_loop_height_pro_U0_imagSrc_data_stream_2_V_read : STD_LOGIC;
    signal Loop_loop_height_pro_U0_mask2_Addr_A : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_loop_height_pro_U0_mask2_EN_A : STD_LOGIC;
    signal Loop_loop_height_pro_U0_mask2_WEN_A : STD_LOGIC_VECTOR (3 downto 0);
    signal Loop_loop_height_pro_U0_mask2_Din_A : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_loop_height_pro_U0_src_axi0_TREADY : STD_LOGIC;
    ...
    signal imagSrc_data_stream_s_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal imagSrc_data_stream_s_empty_n : STD_LOGIC;
    signal imagSrc_data_stream_1_full_n : STD_LOGIC;
    signal imagSrc_data_stream_1_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal imagSrc_data_stream_1_empty_n : STD_LOGIC;
    signal imagSrc_data_stream_2_full_n : STD_LOGIC;
    signal imagSrc_data_stream_2_dout : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal ap_sync_reg_Loop_loop_height_pro_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Loop_loop_height_pro_U0_ap_ready : STD_LOGIC;
    signal Loop_loop_height_pro_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component vip_maskMerge_AXILiteS_s_axi IS
    generic (
...
begin
    vip_maskMerge_AXILiteS_s_axi_U : component vip_maskMerge_AXILiteS_s_axi
    generic map (
    ...
    imagSrc_data_stream_s_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    imagSrc_data_stream_1_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    imagSrc_data_stream_2_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_Loop_loop_height_pro_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
    ...
    Loop_loop_height_pro_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Loop_loop_height_pro_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Loop_loop_height_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Loop_loop_height_pro_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = Loop_loop_height_pro_U0_ap_ready))) then 
                Loop_loop_height_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Loop_loop_height_pro_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Loop_loop_height_pro_U0_ap_start <= ((ap_sync_reg_Loop_loop_height_pro_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    ap_sync_Loop_loop_height_pro_U0_ap_ready <= (ap_sync_reg_Loop_loop_height_pro_U0_ap_ready or Loop_loop_height_pro_U0_ap_ready);
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= Mat2AXIvideo_U0_ap_done;
    ap_sync_ready <= (ap_sync_Loop_loop_height_pro_U0_ap_ready and ap_sync_AXIvideo2Mat_U0_ap_ready);
    dst_axi_TDATA <= Mat2AXIvideo_U0_dst_axi_TDATA;
    dst_axi_TDEST <= Mat2AXIvideo_U0_dst_axi_TDEST;
    dst_axi_TID <= Mat2AXIvideo_U0_dst_axi_TID;
    dst_axi_TKEEP <= Mat2AXIvideo_U0_dst_axi_TKEEP;
    ...
    mask2_EN_A <= Loop_loop_height_pro_U0_mask2_EN_A;
    mask2_Rst_A <= ap_rst_n_inv;
    mask2_WEN_A <= (0=>ap_const_logic_0, others=>'-');
    src_axi0_TREADY <= Loop_loop_height_pro_U0_src_axi0_TREADY;
    src_axi1_TREADY <= AXIvideo2Mat_U0_src_axi1_TREADY;
