...
if {[file isfile vip_maskMerge.autotvin.dat]} {
	file delete -force vip_maskMerge.autotvin.dat
}

if {[file isfile vip_maskMerge.autotvout.dat]} {
	file delete -force vip_maskMerge.autotvout.dat
}
