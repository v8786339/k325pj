...
# ==============================================================
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vip_maskMerge.autotvin.dat"
	set constFileTvOut       "vip_maskMerge.autotvout.dat"
	set constFileHdlTvIn     "vip_maskMerge.autohdltvin.dat"
	set constFileHdlTvOut    "vip_maskMerge.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
